...
subplot(3,3,2); im(x(ymi:yma),y(ymi:yma),flipud(abs_meanFBloch((nx-yma):(nx-ymi),(ny-yma):(ny-ymi)))/sin(nom_fa*pi/180),[0 1]); 
...
subplot(3,3,3); im(x(ymi:yma),y(ymi:yma),flipud(angle_meanFBloch((nx-yma):(nx-ymi),(ny-yma):(ny-ymi))),[-180 180]); 
...
subplot(334); im(x(xmi:xma),f,(flipud(squeeze(complexE((nx-xma):(nx-xmi),y1,:)))),[0 3]); hold on;
...
subplot(335); im(x(xmi:xma),f,(flipud(squeeze(magE((nx-xma):(nx-xmi),y1,:)))),[0 1.5]); hold on;
...
subplot(336); im(x(xmi:xma),f,(flipud(squeeze(phaseE((nx-xma):(nx-xmi),y1,:)))),[0 180]); hold on;
...
subplot(337); im(y(ymi:yma),f,flipud(fliplr(squeeze(complexE(x1,(ny-yma):(ny-ymi),:)))),[0 3]); hold on;
...
subplot(338); im(y(ymi:yma),f,flipud(fliplr(squeeze(magE(x1,(ny-yma):(ny-ymi),:)))),[0 1.5]); hold on;
...
subplot(339); im(y(ymi:yma),f,flipud(fliplr(squeeze(phaseE(x1,(ny-yma):(ny-ymi),:)))),[0 180]); hold on;
