...
seqType=1;                                              % pulse sequence, 1: STFR 2: SPGR 
%% Pulse Design
% spectral
...
% spectral-spatial
[btd_specspat,gxtd_specspat,gytd_specspat,gztd_specspat,...% designs tip-down (and tip-up) prewinding pulse set
   btu_specspat,gxtu_specspat,gytu_specspat,gztu_specspat,...
   d,m_atEcho_specspat,m_beforeTipup_specspat,m_afterTipup_specspat]=prewinding_pulse((pulseType+1),...
   seqType, b0map, roi, simuRange,zslice,nom_fa, Tread, 'doplot',1);
